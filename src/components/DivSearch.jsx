    ...
    <form className="w-11/12 sm:w-full max-w-4xl mx-auto" onSubmit={handleSearchSubmit}>
      <div className="flex gap-2">
        <div className="flex-1 relative">
          <input
            className="w-full px-4 py-2 pl-10 bg-white border-2 border-gray-600 text-black placeholder-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 hover:border-gray-700 transition-colors"
            type="search"
