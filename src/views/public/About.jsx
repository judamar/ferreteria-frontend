    ...
    <div className="container mx-auto px-4 py-8 flex flex-col justify-between gap-6">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <h1 className="text-3xl md:text-4xl text-red-700 text-center font-bold mb-6">Nuestra Historia</h1>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <h1 className="text-3xl md:text-4xl text-red-700 text-center font-bold mb-6">Nuestra Misión</h1>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <h1 className="text-3xl md:text-4xl text-red-700 text-center font-bold mb-6">Contáctanos</h1>
